...
(cl:in-package turtlebot_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <msgTutorial>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msgTutorial)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_pkg-msg:<msgTutorial> is deprecated: use turtlebot_pkg-msg:msgTutorial instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <msgTutorial>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_pkg-msg:data-val is deprecated.  Use turtlebot_pkg-msg:data instead.")
  (data m))
