...
if("TRUE" STREQUAL "TRUE")
  set(hls_lfcd_lds_driver_SOURCE_PREFIX /home/bonobono/catkin_ws/src/hls_lfcd_lds_driver)
  set(hls_lfcd_lds_driver_DEVEL_PREFIX /home/bonobono/catkin_ws/devel)
  ...
  set(hls_lfcd_lds_driver_INSTALL_PREFIX /home/bonobono/catkin_ws/install)
...
if(NOT "/home/bonobono/catkin_ws/src/hls_lfcd_lds_driver/include " STREQUAL " ")
  set(hls_lfcd_lds_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/bonobono/catkin_ws/src/hls_lfcd_lds_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'hls_lfcd_lds_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'hls_lfcd_lds_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bonobono/catkin_ws/src/hls_lfcd_lds_driver/${idir}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
    endif()
